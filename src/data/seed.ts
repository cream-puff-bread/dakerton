...
export const seedHackathonDetails: HackathonDetail[] = [
  ...
  },
  {
    ...
    sections: {
      overview: {
        summary: "바이브 코딩 워크플로우를 개선하는 AI 아이디어를 제안하고 프로토타입을 구현합니다.",
        teamPolicy: { allowSolo: true, maxTeamSize: 5 },
      },
      info: {
        notice: [
          "아이디어의 참신성과 실현 가능성이 주요 평가 기준입니다.",
          "프로토타입은 데모 수준으로 충분합니다.",
        ],
        links: { rules: "#", faq: "#" },
      },
      eval: {
        metricName: "FinalScore",
        description: "아이디어 참신성, 실현 가능성, 발표력을 종합 평가합니다.",
      },
      schedule: {
        timezone: "Asia/Seoul",
        milestones: [
...
export const seedTeams: Team[] = [
  {
    ...
    intro: "빠른 프로토타이핑으로 MVP를 먼저 완성하고 확장합니다.",
  ...
  },
  {
    ...
    isOpen: true,
    memberCount: 1,
    lookingFor: ["Frontend", "ML Engineer", "DevOps"],
    intro: "AI 기반 자동 문서화 도구를 만들어 봅니다.",
  ...
  },
  {
    ...
    intro: "바이브 코딩 UX를 개선하는 크롬 익스텐션을 만듭니다.",
  ...
  {
    teamCode: "T-AIMERS-02",
    hackathonSlug: "aimers-8-model-lite",
    name: "LiteLab",
    isOpen: true,
    memberCount: 2,
    lookingFor: ["Backend", "Frontend"],
    intro: "경량 모델 벤치마크 자동화 파이프라인을 구축합니다.",
    contact: { type: "link", url: "https://open.kakao.com/o/example8" },
    ownerUserId: "user-6",
    ownerRole: "ML Engineer",
    createdAt: "2026-02-21T09:00:00+09:00",
  },
];
